...
/**
 * Get recent conversation history INCLUDING bot messages.
 * Used to provide context when a session is reset and the agent
 * starts fresh without any prior conversation memory.
 */
